...
function Home() {
 ...
 <a href="https://drive.google.com/file/d/10oGfWJIx2v4vw6IhQZfwZ8E37E66wp_3/view?usp=sharing" target="_blank"type="button" className="btn btn-outline-secondary av">View My CV. <i className="bi bi-box-arrow-up-right" style={{color:"rgb(65, 201, 255)"}}></i></a>
 </div></div>
