  ...
  return (
    ...
    <div className='about-box'>
     ...
     <div className='resume-click'>
      <a href="https://drive.google.com/file/d/10oGfWJIx2v4vw6IhQZfwZ8E37E66wp_3/view?usp=sharing" target="_blank" rel="noreferrer"type="button" className="btn btn-outline-secondary av">Resume </a></div>
    </div>
